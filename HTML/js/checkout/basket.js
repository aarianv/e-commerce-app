 ...
 export function renderBasket() {
  ...
  basket.forEach((basketItem) => {
    ...
    cartSummaryHTML += `
      ...
      <label for="delivery-info">DELIVERY</label><br>
      <select id="country"> 
      ...
      <input type="text" id="postcode" value="POSTAL CODE"><br>
      <input type="number" id="phone" value="PHONE"><br>
      <input type="checkbox" id="phone">
      <label for="phone">TEXT ME WITH NEWS AND OFFERS</label><br>
    `;
  });
